...
#define  CONFIG_HLP_GPIO_CONTROLLER        "USRP GPIO controller\n"
...
#define CMDLINE_NRUEPARAMS_DESC {  \
  ...
  {"gpio_controller",              CONFIG_HLP_GPIO_CONTROLLER, 0,               .strptr=&nrUE_params.gpio_controller,        .defstrval="none", TYPE_STRING,   0}, \
}
// clang-format on
