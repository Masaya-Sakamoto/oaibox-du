...
#define OAIBOX_MOD_SYMBOLS_EXPORT_ADDRESS "127.0.0.1"
#define OAIBOX_MOD_SYMBOLS_EXPORT_PORT 63138
...
void init_mod_symbols_export()
{
  ...
  oaibox_mod_symbols_export_servaddr.sin_port = htons(OAIBOX_MOD_SYMBOLS_EXPORT_PORT);
  oaibox_mod_symbols_export_servaddr.sin_addr.s_addr = inet_addr(OAIBOX_MOD_SYMBOLS_EXPORT_ADDRESS);
}
